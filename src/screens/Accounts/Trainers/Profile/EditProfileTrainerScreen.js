...
const EditProfileTrainerScreen = ({ navigation }) => {
    ...
    const handleSave = async () => {
        try {
            const userId = auth.currentUser.uid;
            const response = await updateTrainerData(userId, userData);
        ...
        <SafeAreaView style={styles.container}>
            ...
            <ScrollView contentContainerStyle={styles.form}>
                ...
                <TextInput
                    ...
                    value={userData?.cost || ''}
                    keyboardType="numeric"
                    onChangeText={(text) => setUserData({ ...userData, cost: text })}
                />
...
export default EditProfileTrainerScreen;
